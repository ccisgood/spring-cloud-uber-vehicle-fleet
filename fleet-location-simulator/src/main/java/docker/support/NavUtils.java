...
public class NavUtils {
    ...
    /**
     * Private Constructor.
     * Suppress default constructor for non-instantiatibilty.
     */
    private NavUtils() {
    ...
    public static double getDistance(Point point1, Point point2) {
        ...
        com.spatial4j.core.shape.Point p1 = ctx.makePoint(point1.getLatitude(), point2.getLongitutde());
        com.spatial4j.core.shape.Point p2 = ctx.makePoint(point2.getLatitude(), point2.getLongitutde());
    ...
    public static double getBearing(Point pt1, Point pt2) {
        double longitude1 = pt1.getLongitutde();
        double longitude2 = pt2.getLongitutde();
    ...
    public static Point getPosition(Point pt1, double d, double brg) {
        ...
        double lon1 = Math.toRadians(pt1.getLongitutde());
    ...
    public static String encodePolyline(List<Point> points) {
        final List<LatLng> latLngs = points.stream().map(point -> new LatLng(point.getLatitude(), point.getLongitutde()))
                .collect(Collectors.toList());
    ...
    public static Point getLookAtPoint(List<Point> points) {
        ...
        for (Point point : points) {
            ...
            accumulatedLongitude += point.getLongitutde();
        }
