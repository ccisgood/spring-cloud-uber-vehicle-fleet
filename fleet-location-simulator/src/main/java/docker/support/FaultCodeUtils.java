...
/**
 * Utility to provide random {@link docker.model.FaultCode}s.
 */
public class FaultCodeUtils {
    ...
    static {
        ...
        faultCode1.setRepairInstruction("Re-inflate tires as soon as possible");
        ...
        faultCode2.setRepairInstruction("Tow or haul to nearest service station for replacement");
        ...
        faultCode3.setRepairInstruction("Verify Software update has been completed if available for this engine.");
        ...
        faultCode4.setRepairInstruction("Cool it down with some ice from freezer");
        ...
        faultCode5.setRepairInstruction("Refill oil and check for leaks");
        faultCode5.setFmi("7");
